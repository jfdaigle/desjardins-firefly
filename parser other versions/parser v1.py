...
def split_description_location(words):
    ...
    if split_at is not None and best_gap >= MIN_LOCATION_GAP:
        description_words = words[:split_at]
        location_words = words[split_at:]
    ...
    description = " ".join(w["text"] for w in words)
